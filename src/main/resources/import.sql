...
INSERT INTO TB_CARS (brand, model, car_year, image_url, price_per_day, is_available, description, fk_category_id, fk_rental_company_id) VALUES ('Porsche', 'Porsche Macan', 2021, 'https://i.imgur.com/KFaTP6q.jpg', 240, true, 'O Porsche Macan 2021 é um SUV de alto desempenho, com um design esportivo e um interior de luxo. Ideal para quem busca aventura e estilo.', 2, 3);


-- Compacto
INSERT INTO TB_CARS (brand, model, car_year, image_url, price_per_day, is_available, description, fk_category_id, fk_rental_company_id) VALUES ('Peugeot', 'Peugeot 208', 2021, 'https://i.imgur.com/czijX7v.png', 130, true, 'O Peugeot 208 2021 é um carro compacto, eficiente e com um design atraente. Perfeito para a vida urbana, com um interior tecnológico e confortável.', 3, 2);
INSERT INTO TB_CARS (brand, model, car_year, image_url, price_per_day, is_available, description, fk_category_id, fk_rental_company_id) VALUES ('Toyota', 'Toyota Yaris', 2020, 'https://i.imgur.com/aKO3dZ6.jpg', 135, true, 'O Toyota Yaris 2020 é um carro compacto versátil e econômico, oferecendo um equilíbrio perfeito entre desempenho e eficiência.', 3, 1);
INSERT INTO TB_CARS (brand, model, car_year, image_url, price_per_day, is_available, description, fk_category_id, fk_rental_company_id) VALUES ('Ford', 'Ford Focus', 2021, 'https://i.imgur.com/ZOE2IzR.jpg', 140, true, 'O Ford Focus 2021 é um hatchback compacto que oferece uma condução dinâmica e um design moderno, ideal para a condução diária na cidade.', 3, 3);
INSERT INTO TB_CARS (brand, model, car_year, image_url, price_per_day, is_available, description, fk_category_id, fk_rental_company_id) VALUES ('Renault', 'Renault Clio', 2019, 'https://i.imgur.com/N0uxk3B.jpg', 125, true, 'O Renault Clio 2019 é um carro compacto com um design atraente e eficiência energética, sendo uma opção econômica e prática para o uso urbano.', 3, 2);
...
-- Elétrico
INSERT INTO TB_CARS (brand, model, car_year, image_url, price_per_day, is_available, description, fk_category_id, fk_rental_company_id) VALUES ('Polestar', 'Polestar V.2', 2021, 'https://i.imgur.com/E4hnrLB.jpg', 220, true, 'O Polestar 2 é um carro elétrico com um design inovador e uma tecnologia avançada, oferecendo um desempenho potente e uma condução suave.', 4, 3);
INSERT INTO TB_CARS (brand, model, car_year, image_url, price_per_day, is_available, description, fk_category_id, fk_rental_company_id) VALUES ('Volkswagen', 'Volkswagen ID.3', 2020, 'https://i.imgur.com/dJ8xJFF.jpg', 210, true, 'O Volkswagen ID.3 2020 é um carro elétrico revolucionário, com um design moderno e uma autonomia impressionante, ideal para o futuro da mobilidade urbana.', 4, 1);
INSERT INTO TB_CARS (brand, model, car_year, image_url, price_per_day, is_available, description, fk_category_id, fk_rental_company_id) VALUES ('Lucid', 'Lucid Air', 2022, 'https://i.imgur.com/scl72R4.jpg', 250, true, 'O Lucid Air 2022 é um sedan elétrico de luxo, conhecido por sua autonomia líder de mercado e tecnologia de ponta.', 4, 2);
INSERT INTO TB_CARS (brand, model, car_year, image_url, price_per_day, is_available, description, fk_category_id, fk_rental_company_id) VALUES ('Rivian', 'Rivian R1T', 2021, 'https://i.imgur.com/fenZLz9.jpg', 260, true, 'O Rivian R1T 2021 é um veículo elétrico utilitário com capacidades off-road impressionantes e um design inovador.', 4, 3);
INSERT INTO TB_CARS (brand, model, car_year, image_url, price_per_day, is_available, description, fk_category_id, fk_rental_company_id) VALUES ('Tesla', 'Tesla Model 3', 2021, 'https://i.imgur.com/5l9GOzt.jpg', 200, true, 'O Tesla Model 3 é um carro elétrico revolucionário, combinando desempenho excepcional com sustentabilidade. Com uma autonomia impressionante e recursos tecnológicos avançados, é ideal para uma experiência de condução futurista.', 4, 3);


-- CARACTERISTICA
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('4 lugares', 'Porta-malas espaçoso', 4, 1);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('4 lugares', 'Porta-malas espaçoso', 4, 2);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('4 lugares', 'Porta-malas espaçoso', 4, 3);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('4 lugares', 'Porta-malas espaçoso', 4, 4);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('4 lugares', 'Porta-malas espaçoso', 4, 5);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('4 lugares', 'Porta-malas espaçoso', 4, 6);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('4 lugares', 'Porta-malas espaçoso', 4, 7);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas espaçoso', 4, 8);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas espaçoso', 4, 9);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas espaçoso', 4, 10);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas espaçoso', 4, 11);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas espaçoso', 4, 12);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas compacto', 4, 13);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas eficiente', 4, 14);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas prático', 4, 15);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas ágil', 4, 16);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas versátil', 4, 17);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas dinâmico', 4, 18);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas inovador', 4, 19);
INSERT INTO TB_CHARACTERISTICS (seats, trunk, car_doors, fk_car_id) VALUES ('5 lugares', 'Porta-malas autônomo', 4, 20);
...
INSERT INTO TB_BOOKINGS (fk_car_id, fk_user_id, booking_start, booking_date, return_date) VALUES (2, 2, '09:00:00', '2023-02-15', '2023-03-15');
